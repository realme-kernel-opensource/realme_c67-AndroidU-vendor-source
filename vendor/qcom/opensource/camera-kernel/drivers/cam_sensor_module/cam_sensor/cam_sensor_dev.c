...
struct cam_sensor_i2c_reg_setting_array {
    struct cam_sensor_i2c_reg_array reg_setting[5900];
    unsigned short size;
...
struct cam_sensor_settings {
    struct cam_sensor_i2c_reg_setting_array zoe_sy_s5kjn1sq03_rear_setting;
    struct cam_sensor_i2c_reg_setting_array zoe_hi846w_front_setting;
    struct cam_sensor_i2c_reg_setting_array zoe_c2519_mono_setting;
    struct cam_sensor_i2c_reg_setting_array zoe_sc201acs_mono_setting;
    struct cam_sensor_i2c_reg_setting_array s5khm6_rear_a300_setting;
    struct cam_sensor_i2c_reg_setting_array s5khm6_rear_a303_setting;
	...
	unsigned int cmd, void *arg)
{
    ...
    case VIDIOC_CAM_FTM_POWNER_UP:
            ...
            {
                case zoe_sy_s5kjn1sq03_rear:
                    ptr = &sensor_settings.zoe_sy_s5kjn1sq03_rear_setting;
                    break;
                case zoe_hi846w_front:
                    ptr = &sensor_settings.zoe_hi846w_front_setting;
                    break;
                case zoe_c2519_mono:
                    ptr = &sensor_settings.zoe_c2519_mono_setting;
                    break;
                case zoe_sc201acs_mono:
                    ptr = &sensor_settings.zoe_sc201acs_mono_setting;
                    break;

                case s5khm6_rear_a300:
                    ptr = &sensor_settings.s5khm6_rear_a300_setting;
                    break;
                case s5khm6_rear_a303:
                    ptr = &sensor_settings.s5khm6_rear_a303_setting;
                    break;
                default:
                    break;
            }
